...
export default function RegisterPage() {
  ...
  const [confPasswordError, setConfPasswordError] =
    useState<string>("подтвердите пароль");
        ...
        <form className="registerForm">
          ...
          <FormGroup>
            ...
            {emailWrong && emailError && (
              <div className="regErrors">{emailError}</div>
            )}
          </FormGroup>
          <br />
          <FormGroup>
          ...
          <FormGroup>
            ...
            <Input
              ...
              value={confPassword}
              className={
                confPasswordWrong && confPasswordError ? "inputErrors" : ""
              }
              required
            />
            {confPasswordWrong && confPasswordError && (
              <div className="regErrors">{confPasswordError}</div>
            )}
          </FormGroup>
          <br />
          <Button
